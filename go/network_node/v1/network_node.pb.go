...
const file_network_node_network_node_proto_rawDesc = "" +
	"\n" +
	"\x1fnetwork_node/network_node.proto\x12\x0fnetwork_node.v1\"[\n" +
	...
	"\rListStoreKeys\x12%.network_node.v1.StoreListKeysRequest\x1a&.network_node.v1.StoreListKeysResponseBLZJgithub.com/product-science/chain-protos/go/network_node/v1;network_node_v1b\x06proto3"

var (
	file_network_node_network_node_proto_rawDescOnce sync.Once
	file_network_node_network_node_proto_rawDescData []byte
)

func file_network_node_network_node_proto_rawDescGZIP() []byte {
	file_network_node_network_node_proto_rawDescOnce.Do(func() {
		file_network_node_network_node_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_network_node_network_node_proto_rawDesc), len(file_network_node_network_node_proto_rawDesc)))
	})
...
func file_network_node_network_node_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_network_node_network_node_proto_rawDesc), len(file_network_node_network_node_proto_rawDesc)),
			NumEnums:      4,
			NumMessages:   17,
			NumExtensions: 0,
			NumServices:   1,
